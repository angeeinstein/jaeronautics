...
def create_app(config_overrides=None):
    ...
    def forum_entry():
        ...
        if token:
            ...
            if token_user is not None and not current_user.is_authenticated:
                ...
                if auto_login_allowed:
                    ...
                    return redirect(url_for("auth.login", next=url_for("forum_entry"), forum_login_source="welcome_email"))
        ...
        if not current_user.is_authenticated:
            ...
            return redirect(url_for("auth.login", next=url_for("forum_entry")))
